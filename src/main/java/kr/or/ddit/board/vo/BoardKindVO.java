...
public class BoardKindVO {
	...
	private char BOARD_KIND_STATUS;
	...
	public BoardKindVO(String BOARD_KIND_TITLE, char BOARD_KIND_STATUS, String BOARD_KIND_CREATOR) {
	...
	public char getBOARD_KIND_STATUS() {
		return BOARD_KIND_STATUS;
	}
	public void setBOARD_KIND_STATUS(char bOARD_KIND_STATUS) {
	...
	public int hashCode() {
		...
		result = prime * result + BOARD_KIND_STATUS;
	...
	public boolean equals(Object obj) {
		...
		if (BOARD_KIND_ID != other.BOARD_KIND_ID)
			return false;
		if (BOARD_KIND_STATUS != other.BOARD_KIND_STATUS)
			return false;
